...
class GymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gym" do
    assert_difference('Gym.count') do
      post gyms_url, params: { gym: { description: @gym.description, founder: @gym.founder, name: @gym.name } }, as: :json
    end
  ...
  test "should update gym" do
    patch gym_url(@gym), params: { gym: { description: @gym.description, founder: @gym.founder, name: @gym.name } }, as: :json
    assert_response 200
  end
